...
\begin{document}
  ...
  \end{lemma}
  \begin{proof}
    (1) Por un lema anterior, ya sabemos que \reticulAcotDef{L/\theta}{\overset{\sim}{\textbf{s}}}{\overset{\sim}{\textbf{i}}}{0/\theta}{1/\theta} es un reticulado acotado.
    Osea solo nos falta ver que \reticulComplDef{L/\theta}{\overset{\sim}{\textbf{s}}}{\overset{\sim}{\textbf{i}}}{{}^{\overset{\sim}{c}}}{0/\theta}{1/\theta} satisface las propiedades de reticulado complementado.
    ...
    (2) Por lema anterior tenemos que $\pi_\theta$ es un homomorfismo de \reticulAcot en \reticulAcotDef{L/\theta}{\overset{\sim}{\textbf{s}}}{\overset{\sim}{\textbf{i}}}{0/\theta}{1/\theta} cuyo nucleo es $\theta$.
